pipeline {
    ...
    stages {
        stage('Clonar el Repositorio'){
            steps {
                git branch: 'addJenkins', credentialsId: 'git-jenkins', url: 'https://github.com/MateoOspinaDev/MicroservicioProyecto-Y-BalanceadorCarga.git'
            }
        }
    ...
    post {
        always {
            emailext (
                ...
                to: 'mateo.ospina@est.iudigital.edu.co',
                from: 'mateo@iudigital.edu.co'
            )
        }
    }
}